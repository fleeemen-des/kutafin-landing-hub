            ...
            <form>
              <div className="flex mb-3">
                <input
                  ...
                  className="flex-grow px-4 py-2 rounded-l-md focus:outline-none text-gray-900 text-sm"
                />
                <button
                  type="submit"
                  className="bg-white text-law-red px-4 py-2 rounded-r-md font-medium text-sm hover:bg-gray-100 transition-colors"
                >
                  Subscribe
                </button>
              </div>
