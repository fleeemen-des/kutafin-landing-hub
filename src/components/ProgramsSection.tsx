...
const ProgramsSection = () => {
  ...
  return <section id="programs" className="py-20 md:py-28 bg-gray-50" ref={sectionRef}>
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {programs.map((program, index) => <div key={program.title} className={`bg-white rounded-lg shadow-lg p-6 card-hover transition-all duration-700 delay-${index * 100} ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
