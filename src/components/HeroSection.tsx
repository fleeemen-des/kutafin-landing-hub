      ...
      <div className="container mx-auto px-6 py-24 pt-32 md:pt-24 relative z-10 bg-red-950">
        <div className="max-w-3xl">
          <div className={`transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <a href="#programs" className="button-primary bg-law-gold text-law-navy hover:bg-white">
                Explore Programs
              </a>
        ...
        <div className={`mt-16 md:mt-32 grid grid-cols-1 md:grid-cols-4 gap-8 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          <div className="bg-white/10 backdrop-blur-md p-6 rounded-md border border-white/20">
            <h3 className="text-4xl font-serif font-bold text-law-gold">90+</h3>
          ...
          <div className="bg-white/10 backdrop-blur-md p-6 rounded-md border border-white/20">
            <h3 className="text-4xl font-serif font-bold text-law-gold">95%</h3>
